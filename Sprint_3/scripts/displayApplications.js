async function fetchApplications() {
	try {
		const response = await fetch(
			"https://earwig.greenriverdev.com/pages/Sprint_3/php/dbAccess/getApplications.php"
		);
		if (!response.ok) {
        ...
        // const formattedAppliedDate = `${applications["dateApplied"].substring(5)}-${applications[dateApplied].substring(2, 4)}`;
