async function fetchUsers() {
	try {
		const response = await fetch(
			"https://earwig.greenriverdev.com/application-tracking-system/Sprint_3/php/dbAccess/getUsers.php"
		);
		if (!response.ok) {
                    ...
                    <li class="row py-3" data-appId="${app.userId}">
                        ...
                        <div class="col-12 col-sm-8 d-flex align-items-center justify-content-between">
                            ...
                            <div class="col-4 justify-content-end d-flex icons">
                                <a class="me-3" href="/application-tracking-system/edit-app.html">
                                ...
                                <a href="/application-tracking-system/delete-app.html">
...
//                             <a class="me-2 me-lg-3" href="/application-tracking-system/edit-app.html">
...
//                                 </svg>
//                             </a>
//                             <a href="/application-tracking-system/edit-app.html">
